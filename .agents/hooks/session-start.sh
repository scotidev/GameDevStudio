#!/bin/bash
# Copilot SessionStart hook: Load project context at session start
# Outputs context information that Copilot sees when a session begins
#
# Input schema (SessionStart): No stdin input

echo "=== Copilot Game Studios — Session Context ==="
