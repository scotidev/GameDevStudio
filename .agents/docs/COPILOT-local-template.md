# COPILOT.local.md Template

Copy this file to the project root as `COPILOT.local.md` for personal overrides.
...
1. Copy this template to your project root: `cp .agents/docs/COPILOT-local-template.md COPILOT.local.md`
2. Edit to match your preferences
3. Verify `COPILOT.local.md` is in `.gitignore` (Copilot reads it from the project root)
